...
/// <summary>
/// Demonstrates various regular expression based text searches using <see cref="TextFragmentAbsorber"/>.
/// </summary>
public class TextSegments
{
    ...
    public static void Run()
    {
        ...
        {
            Console.Error.WriteLine($"Error in TextSegments.Run: {ex.Message}");
        }
    }
}